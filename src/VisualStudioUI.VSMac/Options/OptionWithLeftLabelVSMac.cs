...
namespace Microsoft.VisualStudioUI.VSMac.Options
{
    public abstract class OptionWithLeftLabelVSMac : OptionVSMac
    {
        ...
        private void CreateView()
        {
            ...
            _control.TrailingAnchor.ConstraintLessThanOrEqualToAnchor(_optionView.TrailingAnchor, -50f).Active = true; // Avoid out of bounds, 50=leftSpace + space of element and Hint + width of Hint
        }
