...
namespace Microsoft.VisualStudioUI.VSMac.Options
{
    public class SwitchableGroupOptionVSMac : OptionVSMac
    {
        ...
        private void CreateView()
        {
            ...
            _switchButton.State = ((SwitchableGroupOption)Option).State.Value ? 1 : 0;
            ...
            ((SwitchableGroupOption)Option).State.PropertyChanged += SwitchPropertyChanged;
        ...
        {
            ((SwitchableGroupOption)Option).State.PropertyChanged -= SwitchPropertyChanged;
            ((SwitchableGroupOption)Option).State.Value = (_switchButton.State == 1);
